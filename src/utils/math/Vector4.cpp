...
Vector4 Vector4::axisAngleToQuaternion(const Vector3& axis, float angle) {
...
Vector4 Vector4::eulerToQuaternion(float pitch, float yaw, float roll) {
...
Vector4 Vector4::quaternionMultiply(const Vector4& q1, const Vector4& q2) {
    return Vector4(
...
Vector4 Vector4::quaternionNormalize(const Vector4& q) {
    return q.normalized();
}

Vector3 Vector4::quaternionToEuler(const Vector4& q) {
...
Vector4 Vector4::rotateVectorByQuaternion(const Vector4& q, const Vector3& v) {
    Vector4 vec(v, 0.0f);
    Vector4 rotated = quaternionMultiply(quaternionMultiply(q, vec), quaternionConjugate(q));
    return rotated;
}

Vector4 Vector4::quaternionConjugate(const Vector4& q) {
